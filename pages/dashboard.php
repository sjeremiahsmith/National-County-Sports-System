                    ...
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            <?php if (empty($recentPlayers)): ?>
                                <tr><td colspan="7" class="text-center py-4 text-muted">No players registered yet.</td></tr>
                            <?php else: ?>
                                ...
                                <tr class="row-<?= $p['status'] ?>">
                                    ...
                                    <td>
                                        ...
                                        <br><small class="text-muted" style="font-size:0.7rem;"><?= sanitize($p['nir_number']) ?></small>
                                    </td>
                                    ...
                                    <td class="text-end">
                                        <div class="btn-group btn-group-sm">
                                            ...
                                            <?php if (hasRole('super_admin')): ?>
                                                <a href="<?= APP_URL ?>pages/players/delete.php?id=<?= $p['id'] ?>" class="btn btn-outline-danger" title="Delete" onclick="return confirm('Are you sure you want to delete <?= addslashes($p['full_name']) ?>? This action cannot be undone.')"><i class="bi bi-trash"></i></a>
                                            <?php endif; ?>
                                        </div>
                                    </td>
                                </tr>
