...
$pageActions = (hasRole(['super_admin', 'county_coordinator', 'lofa_admin', 'bong_admin', 'kru_admin', 'gedeh_admin', 'sports_coord']) && !isCoordViewer())
    ? '<a href="' . APP_URL . 'pages/players/register.php" class="btn btn-primary btn-sm"><i class="bi bi-person-plus"></i> Register Player</a>'
    : '';
?>
