            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block sidebar collapse">
                <div class="position-sticky pt-3">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link position-relative <?= strpos($_SERVER['PHP_SELF'], 'notifications') !== false ? 'active' : '' ?>" href="<?= APP_URL ?>pages/notifications.php">
                                <i class="bi bi-bell me-2"></i>Notifications
                                <?php $notifCount = getUnreadNotificationCount($_SESSION['user_id']); ?>
                                <?php if ($notifCount > 0): ?>
                                    <span class="position-absolute top-50 end-0 translate-middle-y badge rounded-pill bg-danger me-2"><?= $notifCount ?></span>
                                <?php endif; ?>
                            </a>
                        </li>
                        <?php endif; ?>
                        ...
                        <?php if (hasRole(['super_admin', 'county_coordinator', 'lofa_admin', 'bong_admin', 'kru_admin', 'gedeh_admin', 'sports_coord']) && !isCoordViewer()): ?>
                        <li class="nav-item">
                        ...
                        <?php endif; ?>
                        <?php if (!isCoordViewer() && !hasRole('association_admin') && !isCountyAdmin()): ?>
                        <li class="nav-item">
                        ...
                        <?php if (hasRole(['super_admin'])): ?>
                        <li class="nav-item">
                            <a class="nav-link <?= strpos($_SERVER['PHP_SELF'], 'media/videos') !== false ? 'active' : '' ?>" href="<?= APP_URL ?>pages/media/videos.php">
                                <i class="bi bi-camera-video me-2"></i>Video
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?= strpos($_SERVER['PHP_SELF'], 'media/gallery') !== false ? 'active' : '' ?>" href="<?= APP_URL ?>pages/media/gallery.php">
                        ...
                        <?php endif; ?>
                        <?php if (hasRole(['super_admin']) && $_SESSION['username'] !== 'sports_coord'): ?>
                        <li class="nav-item">
